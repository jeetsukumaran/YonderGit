...
_prog_version = 'ygit-Remote Version 1.0'
_prog_description = """\
...
def main():
    ...
    parser.add_option('--debug',
        ...
        dest='show_debug',
        default=False,
        help='show debugging messages (assumes "--commands")')        
                                  
#     parser.add_option('--show-examples',
#         action='store_true',
#         dest='example_urls',
#         default=False,
#         help="show example repository reference URL's")          
...
#     act_opts.add_option('-s', '--setup',
#         action='store_true',
#         dest='setup',
#         default=False,
#         help=')
# 
#     act_opts.add_option('-c', '--create',
#         action='store_true',
#         dest='create',
#         default=False,
#         help='create and initialize a new repository at REPO-URL')
#             
#     act_opts.add_option('-i', '--init',
#         action='store_true',
#         dest='init',
#         default=False,
#         help='initialize a new repository at REPO-URL')            
#                             
#     act_opts.add_option('-a', '--add',
#         action='store_true',
#         dest='add',
#         default=False,
#         help='add the repository at REPO-URL as a remote ' \
#             + 'of the local one')           
#             
#     act_opts.add_option('--check', 
#         action='store_true',
#         dest='check',
#         default=False,
#         help='check if REPO-URL exists')            
#             
#     act_opts.add_option('--rm', '--remove', 
#         action='store_true',
#         dest='remove',
#         default=False,
#         help='delete REPO-URL (WARNING: this uses "rm -r" to delete the' \
#              + 'specified path: there is no way to undo the results! Use ' \
#              + ' caution!)')
    ...
    add_opts.add_option('-n', '--name', 
        ...
        dest='name',
        default=None,
        help='name for repository at REPO-URL (default is basename of REPO-URL)')
    ...
    if len(args) < 2 or args[0].lower().startswith("actions"):
        ...
        messenger.error("ygit.py [options] <ACTION> <REPO-URL>\n")
    ...
    if opts.name is None:
        remote_name = repo_ref.repo_basename
    else:
